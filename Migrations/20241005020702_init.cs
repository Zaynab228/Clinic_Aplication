        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateApointment = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_medicicals", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "UserApplicationUserApplication",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserApplicationUserApplication", x => new { x.DoctorsId, x.patientId });
                    table.ForeignKey(
                        name: "FK_UserApplicationUserApplication_AspNetUsers_DoctorsId",
                        column: x => x.DoctorsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_UserApplicationUserApplication_AspNetUsers_patientId",
                        column: x => x.patientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_medicicals_DoctorID",
                table: "medicicals",
                column: "DoctorID");

            migrationBuilder.CreateIndex(
                name: "IX_medicicals_patientID",
                table: "medicicals",
                column: "patientID",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserApplicationUserApplication_patientId",
                table: "UserApplicationUserApplication",
                column: "patientId");
        }
